...
exports.PriorityEnforcer = exports.PRIORITY_HIERARCHY = void 0;
exports.PRIORITY_HIERARCHY = [
...
class PriorityEnforcer {
     ...
     */
    getLevel(source) {
        const found = exports.PRIORITY_HIERARCHY.find(p => source.includes(p.name));
     ...
     */
    mightConflict(directive, constraint) {
     ...
     */
    isContradiction(directive, keyword, constraint) {
     ...
     */
    lineViolatesConstraint(line, constraint) {
...
exports.PriorityEnforcer = PriorityEnforcer;
//# sourceMappingURL=priority-enforcer.js.map