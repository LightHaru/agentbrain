...
exports.AnteriorCingulate = void 0;
class AnteriorCingulate {
     ...
     */
    selfAssess(response, userSentiment) {
        ...
        if (/```|http|\/|\.md|\.ts|\.js/.test(response))
            score += 0.1;
     ...
     */
    extractLessons(outcome, userMessage, agentResponse, userSentiment) {
        const lessons = [];
        if (outcome === 'failure') {
     ...
     */
    determineAdjustments(outcome, userSentiment, userMessage) {
        const adjustments = [];
        ...
        for (const block of blocks) {
            ...
            if (timestamp && taskMatch) {
                reflections.push({
                    ...
                    outcome: outcomeMatch?.[1] || 'partial',
...
exports.AnteriorCingulate = AnteriorCingulate;
//# sourceMappingURL=cingulate.js.map