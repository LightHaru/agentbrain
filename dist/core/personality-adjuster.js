...
exports.PersonalityAdjuster = void 0;
class PersonalityAdjuster {
    adjustmentHistory = [];
    weeklyChanges = new Map(); // trait -> cumulative change this week
    /**
     * Adjust personality traits based on feedback patterns
     * Returns updated traits
     */
    adjust(current, feedbackPatterns) {
     ...
     */
    applyChange(trait, currentValue, delta, timestamp, reason) {
...
exports.PersonalityAdjuster = PersonalityAdjuster;
//# sourceMappingURL=personality-adjuster.js.map