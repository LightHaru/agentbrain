...
export class QueryAnalyzer {
   ...
   */
  async analyze(query: string, topic: string = ''): Promise<QueryContext> {
   ...
   */
  private detectTaskType(query: string): string | null {
   ...
   */
  private assessComplexity(query: string): QueryContext['complexity'] {
   ...
   */
  private buildFilters(query: string): QueryContext['filters'] {
